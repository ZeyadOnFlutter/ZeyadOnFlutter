...
- 🌱 **Learning:** Advanced Clean Architecture & Scalable Mobile Apps
...
|---------|-------------|-------------|
| **🚗 Scrap** | React Native, JavaScript, UI Components | Car scrap & spare parts app (Venustusy Internship) |
| **🏢 Zahra** | Flutter, Firebase, Payment APIs | Compound management with secure auth & payments |
| **🛒 Ecommerce** | Cubit, REST APIs, Clean Architecture | Full-featured shopping app with cart, wishlist & auth |
| **🎬 Movies App** | Cubit, YTS.mx API, Group Project | Movie browser with favorites & real-time data |
| **📅 Evently** | Firebase, Provider, Maps Integration | Event discovery with bilingual support |
| **📰 News App** | Cubit, Provider, MVVM | Categorized news with real-time API updates |
...
| **💼 Jobsque** | Provider, API Integration, 2FA | Job portal with secure login & resume uploads |
